        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5">
          {items.map((p, i) => (
            <motion.div key={p.slug}
              ...
              <Link to={`/case-studies/${p.slug}`} className="group block relative overflow-hidden rounded-2xl">
                <div className={`relative overflow-hidden ${i === 2 ? "aspect-[21/8]" : "aspect-[4/3]"}`}>
